                ...
                <div class="top">
                    ...
                    <div class="flex">
                        ...
                        <?php if ($row["is_completed"]) { ?>
                            ...
                            <i class="fa-solid fa-square-check"></i> Abgeschlossenes Projekt
                            </div>
                        <?php } ?>
                    </div>
                </div>
