...
document.querySelectorAll('input[name="predamage"]').forEach((radioButton) => {
    radioButton.addEventListener('change', (event) => {
        ...
        if (selectedOption === 'Ja') {
            ...
            toggleRequiredAttributes(predamageFields, false);
        }
    });
});


const holdFields = ['hold_creditor', 'hold_street', 'hold_postalcode', 'hold_place', 'hold_contact', 'hold_email'];
...
document.querySelectorAll('input[name="hold"]').forEach((radioButton) => {
    radioButton.addEventListener('change', (event) => {
        ...
        if (selectedOption === 'Ja') {
            ...
            toggleRequiredAttributes(holdFields, false);
        }
    });
});
...
const coinsuredFields = ['coinsured_company', 'coinsured_street', 'coinsured_postalcode', 'coinsured_place', 'BI_self_consumption_tariff', 'coinsured_function'];
...
document.querySelectorAll('input[name="coinsured"]').forEach((radioButton) => {
    radioButton.addEventListener('change', (event) => {
        ...
        if (selectedOption === 'Ja') {
            ...
            toggleRequiredAttributes(coinsuredFields, false);
        }
    });
});
